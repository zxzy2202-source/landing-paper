    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row border border-gray-200">
          ...
          {/* Left: Contact Info */}
          <div id="hg" className="lg:w-5/12 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white p-10 lg:p-14 flex flex-col justify-between relative overflow-hidden">
